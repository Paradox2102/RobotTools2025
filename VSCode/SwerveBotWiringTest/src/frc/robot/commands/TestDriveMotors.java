...
public class TestDriveMotors extends Command {
  ...
  public void execute() {
    ...
    Logger.log("TestDriveMotors", 1, String.format(",%f,%f,%f,%f", m_FLModule.getDriveSpeed(), m_BLModule.getDriveSpeed(), m_BRModule.getDriveSpeed(), m_FRModule.getDriveSpeed()));
