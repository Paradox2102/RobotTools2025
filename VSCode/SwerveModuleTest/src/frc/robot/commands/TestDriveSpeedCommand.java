 ...
 */
public class TestDriveSpeedCommand extends Command {
   ...
   */
  public TestDriveSpeedCommand(MotorSubsystem subsystem, double time) {
    Logger.log("TestMotorSpeedCommand", 3, "TestMotorSpeedCommand()");

    m_subsystem = subsystem;
    m_time = time;
    m_rightEncoder = subsystem.getDriveEncoder();
  ...
  public void initialize() {
    ...
    m_timer.start();
    m_timer.reset();
    m_subsystem.setDrivePower(k_power);
  }
