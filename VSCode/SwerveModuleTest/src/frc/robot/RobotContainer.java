...
import frc.robot.commands.TestDriveSpeedCommand;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    m_commandJoystick.button(1).toggleOnTrue(new TestDriveSpeedCommand(m_driveSubsystem, 10));
    m_commandJoystick.button(2).toggleOnTrue(new TestDriveRamp(m_driveSubsystem));
    m_commandJoystick.button(3).toggleOnTrue(new TestSteeringRamp(m_driveSubsystem));
  }
