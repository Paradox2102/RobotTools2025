...
public class DriveSubsystem extends SubsystemBase {
  ...
  public static final double k_minPowerLeft = 0.22;
  public static final double k_minPowerRight = 0.21;
  public static final double k_maxSpeed = 500;

  private static final double k_Fleft = 1 / k_maxSpeed;
  private static final double k_Fright = 0.92 / k_maxSpeed;
  ...
  public static final double k_ticksPerMeter = 1003 / 0.745;
